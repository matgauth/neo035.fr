    ...
    },
    {
      ...
      options: {
        headers: {
          ...
          '/admin/*': [
            `Content-Security-Policy: block-all-mixed-content; base-uri 'self'; default-src 'self' blob: data: raw.githubusercontent.com; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; object-src 'none'; form-action 'self'; font-src 'self' data:; connect-src 'self' blob:`,
          ],
