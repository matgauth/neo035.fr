      ...
      options: {
        headers: {
          '/*': [
            ...
            `Content-Security-Policy: block-all-mixed-content; base-uri 'self'; default-src 'self' data: i.ytimg.com ${cloudfrontId}.cloudfront.net; script-src 'self' 'unsafe-inline' matm.at; style-src 'self' 'unsafe-inline' fonts.googleapis.com; object-src 'none'; form-action 'self'; font-src 'self' data: ${cloudfrontId}.cloudfront.net fonts.gstatic.com; connect-src 'self' www.googleapis.com`,
          ],
          '/admin/*': [
